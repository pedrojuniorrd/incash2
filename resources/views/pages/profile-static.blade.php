        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-uppercase text-sm">Informacoes da Conta</p>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="email" value="pedrojuniorrd@gmail.com">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Endereço cadastrado</label>
                                    <input class="form-control" type="text"
                                        value="TESTE ENDEREÇO">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Cidade</label>
                                    <input class="form-control" type="text" value="São Luís">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
