                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Cargo
                                    </th>
                                    <th
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-3 py-1">
                                            <div>
                                                <img src="x" class="avatar me-3" alt="image">
                                            </div>
                                    ...
                                    <td class="align-middle text-end">
                                        <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                            ...
                                            <p class="text-sm font-weight-bold mb-0 ps-2">Deletar</p>
                                        </div>
                                    </td>
                                </tr>
                                <!-- <tr>
